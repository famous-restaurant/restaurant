	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="${ pageContext.request.contextPath }/resources/html/home.jsp" class="nav-link">Home</a></li>
	          <li class="nav-item"><a href="resources/html/about.jsp" class="nav-link">About</a></li>
	          <li class="nav-item"><a href="resources/html/agent.html" class="nav-link">Agent</a></li>
	          <li class="nav-item"><a href="resources/html/services.html" class="nav-link">Services</a></li>
	          <li class="nav-item"><a href="resources/html/properties.html" class="nav-link">Properties</a></li>
	          <li class="nav-item"><a href="resources/html/blog.html" class="nav-link">로그인</a></li>
	          <li class="nav-item"><a href="resources/html/contact.html" class="nav-link">Contact</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
